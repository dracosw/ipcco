 ...
 
{
          ...
          //  var obj = jQuery.parseJSON(msg);  
               ...
               if( obj.status == "ok"){
                    ...
                    for(var i=0;i<objdata.length;i++){
                        ...
                        cadena_cat_1+='<div style="width:48%; height:auto; float:left;  padding:0%; margin-bottom:6px; margin-right:6px;  position:relative; ">';
                        cadena_cat_1+='   <div class="contain_producto_sel" style="width:100%; height:240px; float:left; background-color:#fff;" id="contain_producto_sel_'+objdata[i].IdProducto+'">';
                        ...
                        cadena_cat_1+='<div style="width:100%; height:161px; float:left; background-image:url('+servidor_ws+'images/products/'+objdata[i].foto+'); background-size:cover; background-position:center; position:relative;">';
                        cadena_cat_1+='<div style="width:65%; height:161px; position:absolute;" onclick="abrir_detalle_sel_descuento('+objdata[i].IdProducto+')">';
                        cadena_cat_1+='</div>';
    ...
    var objectdatGlobal=new Object();
          ...
          //  var obj = jQuery.parseJSON(msg);  
            var cadena_combo="";
              if( obj.status == "ok"){
                ...
                objectdatGlobal=new Object();
                objectdatGlobal=obj.datos;
                ...
                for(var i=0;i<objectdat.length;i++){
                    cadena_listado_pedi+='<div onclick="get_pedido('+objectdat[i].IdCarrito+','+objectdat[i].estadoCarrito+','+i+')" class="item_pedido">';
                    ...
                    var estado_pedi="";
                     ...
                     if(""+objectdat[i].estadoCarrito=="1"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Nuevo</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="2"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Pendiente de Pago</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="3"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Pagado</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="4"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>En Producción</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="5"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Enviado</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="6"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Entregado</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="7"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>En Devolución</span>";
                    }

                    if(""+objectdat[i].estadoCarrito=="8"){
                        estado_pedi="<span style='background-color:#702d8e; padding-top:2px; padding-bottom:2px; padding-right:4px; padding-left:4px; border-radius:5px; color:#fff;'>Cancelado</span>";
                    }
    ...
    function abrir_producto_detail(obj_producto,obj_galeria,obj_colors,obj_tallas,obj_redes){
        ...
        */
        ...
        var cadana_telefono=""+obj_producto[0].telefonosFabricante;
        var arra_telefonos=new Array();

        if(cadana_telefono!=""){
            arra_telefonos=cadana_telefono.split("-");
        }
        
        var cadena_de_telefonos="";

        for(var j=0;j<arra_telefonos.length; j++){
            var tel_sel=""+arra_telefonos[j];
            tel_sel=tel_sel.trim();
            cadena_de_telefonos+='<a class="ui-btn ui-shadow ui-corner-all" style="margin-bottom:5px; width:77%; background-color: #536dfe; color: #fff; text-shadow:none;" href="tel:'+tel_sel+'"><img src="assets/img/phone.png" style=" width: 20px;    float: left;" >'+tel_sel+'</a>';
        }


        $("#tel_fab").html(cadena_de_telefonos);
        $("#email_fab").html(""+obj_producto[0].emailFabricante);

        if(""+obj_producto[0].ver_datos_fabricantes=="SI" && ""+id_usuario_reg!=""){
        ...
        for(var i=0;i<obj_redes.length;i++){
            var url_red=""+obj_redes[i].urlRedSocial; 
            url_red=url_red.toLowerCase();

            if(""+url_red!=""){
                if(""+url_red!="null"){

                    cadena_redes+='<button type="button"  onclick="abrir_url_redes(&#39;'+obj_redes[i].urlRedSocial+'&#39;)"  style="width:50px; height:50px; margin-left:5px; display:inline-block; background-color:#fff; color:#fff; border:1px solid #E72C78; border-radius:9px; ">';
    ...
    var arraConfigEnvio=new Array();
     ...
     function get_pedido(idcarrito,est_ped_sel,index_sel){
        ...
        if(parseInt(est_ped_sel)==1){

            cadena_botones+='<button style=" width:33%; background-color: #a8afb3; color: #fff; height: 55px; float:left;  text-shadow:none; "  id="btn_limpiar" onclick="limpiar_pedido_abrir()" >Limpiar </button>';



           cadena_botones+=' <button style=" width:33%; background-color: #536dfe; color: #fff; float:left; height: 55px;  text-shadow:none;" onclick="actualizar_carrito(1)"  id="btn_actualizar_carrito"  > Actualizar </button>';

           
        }

        if(parseInt(est_ped_sel)<=2){
             cadena_botones+=' <button style=" width:33%; background-color: #ececec !important; color: #8c8c8c; height: 55px; float:left;  text-shadow:none; "  id="btn_cancelar" onclick="cancelar_pedido_abrir()"> Cancelar </button>';
        }

       

        if(parseInt(est_ped_sel)==1){
            cadena_botones+=' <button style=" width:100%; background-color: #536dfe; color: #fff; float:left; height: 55px;  text-shadow:none;" onclick="actualizar_estado(2)"  id="btn_actualizar_carrito"  > Aprobar Compra </button>';
        }
        ...
        if(parseInt(est_ped_sel)==2){
            ...
            cadena_botones+='<form id="frm_botonePayco" name="frm_botonePayco" method="post" action="https://secure.payco.co/checkout.php" target="_blank"> ';
            cadena_botones+='<input name="p_cust_id_cliente" type="hidden" value="'+objectdatGlobal[index_sel].p_cust_id_cliente+'"> ';
            cadena_botones+='<input name="p_key" type="hidden" value="'+objectdatGlobal[index_sel].p_key+'"> ';
            cadena_botones+='<input name="p_id_invoice" type="hidden" value="'+objectdatGlobal[index_sel].p_id_invoice+'"> ';
            cadena_botones+='<input name="p_description" type="hidden" value="ePayco Test"> ';
            cadena_botones+='<input name="p_currency_code" type="hidden" value="'+objectdatGlobal[index_sel].p_currency_code+'"> ';
            cadena_botones+='<input name="p_amount" id="p_amount" type="hidden" value="'+objectdatGlobal[index_sel].p_amount+'"> ';
            cadena_botones+='<input name="p_tax" id="p_tax" type="hidden" value="0"> ';
            cadena_botones+='<input name="p_amount_base" id="p_amount_base" type="hidden" value="0"> ';
            cadena_botones+='<input name="p_test_request" type="hidden" value="TRUE"> ';
            cadena_botones+='<input name="p_url_response" type="hidden" value="https://ipcco.co/ecomm/respuesta.html"> ';
            cadena_botones+='<input name="p_url_confirmation" type="hidden" value="https://ipcco.co/ecomm/confirmacion.php"> ';
            cadena_botones+='<input name="p_signature" type="hidden" id="signature" value="'+objectdatGlobal[index_sel].p_signature+'" /> ';
            cadena_botones+='<input name="p_billing_document"type="hidden" id="p_billing_document" value="'+objectdatGlobal[index_sel].p_billing_document+'" /> ';
            cadena_botones+='<input name="p_billing_name"type="hidden" id="p_billing_name" value="'+objectdatGlobal[index_sel].p_billing_name+'" /> ';
            cadena_botones+='<input name="p_billing_lastname"type="hidden" id="p_billing_lastname" value="'+objectdatGlobal[index_sel].p_billing_lastname+'" /> ';
            cadena_botones+='<input name="p_billing_address"type="hidden" id="p_billing_address" value="'+objectdatGlobal[index_sel].p_billing_address+'" /> ';
            cadena_botones+='<input name="p_billing_country"type="hidden" id="p_billing_country" value="'+objectdatGlobal[index_sel].p_billing_country+'" /> ';
            cadena_botones+='<input name="p_billing_email"type="hidden" id="p_billing_email" value="'+objectdatGlobal[index_sel].p_billing_email+'" /> ';
            cadena_botones+='<input name="p_billing_phone"type="hidden" id="p_billing_phone" value="'+objectdatGlobal[index_sel].p_billing_phone+'" /> ';
            cadena_botones+='<input name="p_billing_cellphone"type="hidden" id="p_billing_cellphone" value="'+objectdatGlobal[index_sel].p_billing_cellphone+'" />               ';
            
            cadena_botones+='</form> ';

            cadena_botones+=' <button style=" width:33%; background-color: #536dfe; color: #fff; float:left; height: 55px;  text-shadow:none;" onclick="pagar_pedido()"  id="btn_actualizar_carrito"  > Pagar </button>';
        }


        $("#cnvbotonera").html(cadena_botones);
            ...
            var cadena_combo="";
              if( obj.status == "ok"){
                ...
                for(var i=0;i<objectdat.length;i++){
                    ...
                    if(parseInt(objectdat[i].estadoCarrito)>=2){
    ...
    function cancelar_pedido_abrir(){
    ...
    function cerrar_pop_cancelar(){
        $("#modal_cancelar_pedido").hide();
    }

    //LIMPIAR PEDIDO

    function limpiar_pedido_abrir(){
        $("#modal_limpiar_pedido").show();
    }
    ...
    function limpiar_pedido(){
        ...
        var request = $.ajax({
            ...
            data: {
                ...
                tipo:"limpiar_pedidos",
                id_pedido:""+idcarrito_sel
    ...
    function cerrar_pop_limpiar(){
        $("#modal_limpiar_pedido").hide();
    }
